...
def main():
    ...
    for i in range(start_iter, args.num_steps):
        ...
        if (i+1) % args.save_pred_every == 0:
            ...
            torch.save( optimizer.state_dict(), os.path.join(args.snapshot_dir_optim, '%s_' % (args.source) + '.pth') )
            wandb.log({"src seg loss": loss_seg_src.data, "psu seg loss": loss_seg_psu.data,
